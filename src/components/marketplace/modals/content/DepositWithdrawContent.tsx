  ...
  return (
    <div className="flex h-10 w-full items-center border border-neutral-600 p-4 pr-0">
      <Menu as="div" className="relative inline-block w-full text-left">
        ...
        <Menu.Items className="absolute right-[-1px] top-[calc(100%+16px)]  border border-neutral-600 bg-neutral-800 ring-1 ring-black ring-opacity-5 focus:outline-none">
          {coins.map((coin) => (
            <Menu.Item
              as="div"
