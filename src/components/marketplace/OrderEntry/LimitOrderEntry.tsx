...
import RangeSlider from "../slider-order/RangeSlider";
      ...
      <div className="md:mx-4">
        ...
        >
          <input
            ...
            className="w-full bg-transparent pb-3 pl-14 pr-14 pt-3 text-right text-xs outline-none"
          />
        </OrderEntryInputWrapper>
